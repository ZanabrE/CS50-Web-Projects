...
*   `templates/planner/index.html`: The main SPA dashboard. It integrates the 7-day Planning Matrix, the Pantry Management panel, the Recipe Recommendations, and the Optimizer Modal into a single fluid view.
